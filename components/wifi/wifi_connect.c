...
#include "esp_event.h"
#include "esp_wifi.h"
#include "esp_netif.h"      // Added: Required for esp_netif_create_default_wifi_sta()
#include "esp_log.h"
...
/* Maximum retry count hardcoded in software */
...
esp_err_t wifi_connect(void)
{
    ...
    // CORRECTED: Ensure the function is properly declared by including esp_netif.h
